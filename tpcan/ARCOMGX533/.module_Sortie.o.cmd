cmd_/user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.o :=  gcc -m32 -Wp,-MD,/user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/.module_Sortie.o.d  -nostdinc -isystem /opt/x86_64/gcc/gcc-3.4.4/lib/gcc/x86_64-gnu-linux/3.4.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fomit-frame-pointer -pipe -msoft-float -mpreferred-stack-boundary=2 -fno-unit-at-a-time  -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement  -I/usr/lib/arcom/realtime/include -Wall -ffast-math -mhard-float  -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(module_Sortie)"  -D"KBUILD_MODNAME=KBUILD_STR(module_Sortie)" -c -o /user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.o /user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.c

deps_/user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.o := \
  /user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.c \
...
/user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.o: $(deps_/user/mollardp/homedir/PenduleE5/tpcan/ARCOMGX533/module_Sortie.o)
